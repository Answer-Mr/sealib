...
// 全局模块 global.js
define("hbweblib/global/0.2.0/js/global-debug", [ "./sea-baseconfig-debug", "./utility-debug", "seajs/seajs-log/1.0.1/seajs-log-debug", "seajs/seajs-style/1.0.1/seajs-style-debug", "seajs/seajs-text/1.0.2/seajs-text-debug", "jquery/jquery/1.10.2/jquery-debug", "gallery/json/1.0.3/json-debug" ], function(require, exports, module) {
    module.exports = {
        "sea-baseconfig": require("./sea-baseconfig-debug"),
        utility: require("./utility-debug"),
        "seajs-log": require("seajs/seajs-log/1.0.1/seajs-log-debug"),
        "seajs-style": require("seajs/seajs-style/1.0.1/seajs-style-debug"),
        "seajs-text": require("seajs/seajs-text/1.0.2/seajs-text-debug"),
        $: require("jquery/jquery/1.10.2/jquery-debug"),
        json: require("gallery/json/1.0.3/json-debug")
    };
});

/**
 * @Description: seajs-baseconfig
 * @Author: xujia(2014-04-09 08:27)
 */
!function() {
    var BASE_RE = /^(.+?\/)(\?\?)?(hbweblib\/)+/, data = seajs.data, base = data.base;
    if (window.staticFileRoot) {
        data.base = window.staticFileRoot + "/static/pinganfuweb-modules/";
    } else {
        data.base = (base.match(BASE_RE) || [ "", base ])[1];
    }
    seajs.config({
        alias: {
            // jquery
            ...
            // hbweblib
            bankinput: "hbweblib/temporary/1.0.0/bankinput",
            dialog: "hbweblib/dialog/1.0.0/dialog",
            formatter: "hbweblib/Formatter/0.1.0/Formatter",
            formValidator: "hbweblib/FormValidator/0.2.1/FormValidator",
            idcard: "hbweblib/FormValidator/0.2.1/idcard",
            loading: "hbweblib/loading/1.0.0/loading",
            magnify: "hbweblib/temporary/1.0.0/magnify",
            numeral: "hbweblib/temporary/1.0.0/numeral",
            pagination: "hbweblib/pagination/1.0.0/pagination",
            pwdGrd: "hbweblib/pwdGrd/1.0.1/pwdGrd",
            "pc-password": "hbweblib/pwdGrd/1.0.1/pc-password",
            sendotp: "consumer/sendotp/1.0.0/sendotp",
            uploader: "hbweblib/uploader/0.1.0/Uploader",
            validator: "hbweblib/Validator/0.1.0/Validator",
            // gallery
            ...
            // hbweblib
            "bankinput-debug": "hbweblib/temporary/1.0.0/bankinput-debug",
            "dialog-debug": "hbweblib/dialog/1.0.0/dialog-debug",
            "formatter-debug": "hbweblib/Formatter/0.1.0/Formatter-debug",
            "formValidator-debug": "hbweblib/FormValidator/0.2.1/FormValidator-debug",
            "idcard-debug": "hbweblib/FormValidator/0.2.1/idcard-debug",
            "loading-debug": "hbweblib/loading/1.0.0/loading-debug",
            "magnify-debug": "hbweblib/temporary/1.0.0/magnify-debug",
            "numeral-debug": "hbweblib/temporary/1.0.0/numeral-debug",
            "pagination-debug": "hbweblib/pagination/1.0.0/pagination-debug",
            "pwdGrd-debug": "hbweblib/pwdGrd/1.0.1/pwdGrd-debug",
            "pc-password-debug": "hbweblib/pwdGrd/1.0.1/pc-password-debug",
            "sendotp-debug": "consumer/sendotp/1.0.0/sendotp-debug",
            "uploader-debug": "hbweblib/uploader/0.1.0/Uploader-debug",
            "validator-debug": "hbweblib/Validator/0.1.0/Validator-debug",
            // gallery
            "handlebars-debug": "gallery/handlebars/1.0.2/handlebars-debug",
            "jsuri-debug": "gallery/jsuri/1.2.2/jsuri-debug",
            "moment-debug": "gallery/moment/2.0.0/moment-debug"
        },
        map: [ [ ".js", ".js?v=" + (window.staticFileVer || "") ] ]
    });
    define("hbweblib/global/0.2.0/sea-baseconfig-debug", [], {});
}();

/**
 * @Description: utility
 * @Author: xujia(2014-09-16 10:53)
 */
!function() {
    ...
    define("hbweblib/global/0.2.0/utility-debug", [], {});
}();
 ...
 */
    ...
    if (typeof module === "object" && module && typeof module.exports === "object") {
        ...
        if (typeof define === "function") {
            define("jquery/jquery/1.10.2/jquery-debug", [], function() {
                return jQuery;
            });
        }
    }
